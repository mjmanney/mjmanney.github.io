		...
		var vm = new Vue({
			...
			data: {
				p: [
					...
					{ t: 'Portfolio'  , d: 'The site you are on now! I am constantly updating and adding new features.  Check out the first iteration of this site see the difference!'             , l: '#', s:'Time Travel', tags: ['AWS S3', 'jQuery', 'Bootstrap', 'Vue.js' , 'Animate.css', 'Responsive Design']             , src:"https://images.pexels.com/photos/247791/pexels-photo-247791.png?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" }
				],
				c: 0
			},
			methods: {
